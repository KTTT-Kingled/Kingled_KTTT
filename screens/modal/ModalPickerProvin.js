...
const OPTION_DANANG = ['Quận Cẩm Lệ','Quận Hải Châu','Quận Liên Chiểu','Quận Ngũ Hành Sơn',' Quận Sơn Trà','Quận Thanh Khê','Huyện Hòa Vang','Huyện Hoàng Sa']
...
const ModalPickerProvince = (props) => {
    ...
    const option = OPTION_DANANG.map((item,index)=>{
        return (
            <TouchableOpacity
                style={styles.option}
                key={index}
